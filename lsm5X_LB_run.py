...
wavelengths = numpy.array([488,660]) #H&E analog convention to list nuclear channel first
laser_powers = numpy.array([10,1]) ##measured actual at sample: 6 and 9 mw, respectively 3-30-22
galvoXoffset = 2.65
galvoYoffset = numpy.array([-1.30, -1.30]) 
galvoXamp = 6.20 # in V
