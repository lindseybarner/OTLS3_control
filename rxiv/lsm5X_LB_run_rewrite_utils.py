...
sys.path.append('E')
drive = 'E'
fname = '1_25_21_5X_OTLS3_HB_A1' # specimen names
copy_to_Zdrive = 'no'
xMin = -12.10#-1.81
xMax = 4.09 #needs to be at least 2mm i think?
#ycenter = -26.67
yMin = -24.68 #ycenter - .385
yMax = 1.57 #ycenter +.7
zMin = -2.71#zcenter - .01
zMax = -1.90 #-2.53 #-2.

# for ECi
xWidth = 0.8457 #0.834 #in um, not mm (2nd gen system 0.48)
xWidth_ch1 = 0.8425 #for 488nm 
...
galvoXoffset = 2.52
galvoYoffset = numpy.array([-1.35, -1.35]) #-.025 for 660 #for 660nm, 488nm respectively. usually these numbers are not the same for 5X imaging.
galvoXamp = 6.20 # in V. should be 1.5V for 20X imaging
...
# automatically write ('data_new.xml') to folder (more accurate)
