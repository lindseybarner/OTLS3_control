...
import lsmfx_LB_restart_test as lsmfx_LB_restart_test
...
sys.path.append('E')
drive = 'E'
fname = '12-12-20_20X_OTLS3_GIC6004-4' # specimen names
copy_to_Zdrive = 'no'
xMin = 17.37 #
...
# ########### BEGIN SCANNING ##############
lsmfx_LB_restart_test.scan3D(drive, fname, xOff, yOff, zOff, xLength, yLength, zLength, xWidth, yWidth, zWidth, yStitchOverlay, zStitchOverlay, camY, camX, expTime, binning, wavelengths, laser_powers, galvoXoffset, galvoXamp, galvofreq, galvoYoffset, camOffset, flatField)
