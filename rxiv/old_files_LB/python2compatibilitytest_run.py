...
############# SCAN PARAMETERS #############
drive = 'C'
fname = 'scan1_ECi_TOPRO3_prostate' # specimen names

xcenter = 5.2
ycenter = 2
zcenter = -3.65
xMin = xcenter - 0.2 #2MM BY 2MM BY 200UM
xMax = xcenter + 0.2
yMin = ycenter - 0.2
yMax = ycenter + 0.2
zMin = zcenter - 0.15
...
xWidth = 0.2 #in um, not mm (2nd gen system 0.48) 
yWidth = 0.35 # mm (2nd gen system 0.8)
zWidth = 0.037 # mm calculated based on 610px/125um 11-20-19(2nd gen system 0.07)
camY = 256 # pixels
camX = 2048 # pixels
expTime = 4.99 # ms
...
############ BEGIN SCANNING ##############
python2compatibilitytest.py2test(drive, fname, xOff, yOff, zOff, xLength, yLength, zLength, xWidth, yWidth, zWidth, camY, camX, expTime, binning, wavelengths, initial_powers, motor_positions, attenuations, camOffset, flatField)